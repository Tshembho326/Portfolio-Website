            ...
            <div className="max-w-5xl mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition-all">
                        ...
                        <p className="text-gray-400 mb-4">Scalable Platform that helped me do ...</p>
                        <div className="flex flex-wrap gap-2 mb-4">
                            {["React.js", "Django", "PostgreSQL"].map((tech, key) =>
                                <span
                                    key={key}
                        ...
                        <div className="flex justify-between items-center">
                            <a href="https://github.com/Tshembho326/READ-backend.git"
